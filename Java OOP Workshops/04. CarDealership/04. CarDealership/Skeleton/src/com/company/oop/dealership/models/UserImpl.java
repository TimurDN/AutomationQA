...
public class UserImpl implements User {
    public static final String NO_COMMENT = "--NO COMMENTS--";
    ...
    public void addVehicle(Vehicle vehicle) {
        ...
        if (getRole() != UserRole.VIP && vehicles.size() >= NORMAL_ROLE_VEHICLE_LIMIT) {
    ...
    @Override // Easier way to do this?
    public String printVehicles() {
        ...
        if (vehicles.size() == 0) {
            ...
            for (Vehicle vehicle : vehicles) {
                ...
                if (comments.size() > 0) {
                    builder.append(COMMENT_HEADER).append(System.lineSeparator());
                    for (Comment comment : comments) {
                        builder.append(comment.toString()).append(System.lineSeparator());
                    }
                    builder.append(COMMENT_HEADER).append(System.lineSeparator());
                } else {
                    builder.append(NO_COMMENT).append(System.lineSeparator());
                }
        ...
        String output = builder.toString().replaceAll("[ \t]*\r?\n([ \t]*\r?\n)+", "\n");
